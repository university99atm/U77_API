...
namespace atmglobalapi.Controllers.Master
{
    ...
    [ApiController]
    [Authorize]
    public class M15ReligionController : ControllerBase
    {
        private readonly IConfiguration _configuration;

        public M15ReligionController(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        [HttpPost("operation")]
        public IActionResult ReligionOperation([FromBody] M15Religion model)
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("[dbo].[U77_Pro_M15_Religionoperation]", con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@ReligionCode", (object?)model.ReligionCode ?? DBNull.Value);
