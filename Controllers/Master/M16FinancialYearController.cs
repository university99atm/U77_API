...
namespace atmglobalapi.Controllers.Master
{
    ...
    [ApiController]
    [Authorize]
    public class M16FinancialYearController : ControllerBase
    {
        private readonly IConfiguration _configuration;

        public M16FinancialYearController(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        [HttpPost("operation")]
        public IActionResult FinancialYearOperation([FromBody] M16FinancialYear model)
        {
            try
            {
